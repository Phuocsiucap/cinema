...
import { promotionService, type PromotionCreate } from '../../services/promotionService';
import { movieService } from '../../services/movieService';
import type { Movie } from '../../types/movie';

export function AddPromotionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Validate
      if (!formData.title || !formData.code || formData.discount_value <= 0) {
    ...
    <AdminLayout>
      <div className="min-h-screen bg-gray-950 p-6">
        ...
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold text-white">Add New Promotion</h1>
          <p className="text-gray-400 mt-2">Create a new discount code or promotional campaign</p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="md:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-600"
                  required
                />
              </div>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-600 resize-none"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-600 uppercase"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-gray-600"
                    required
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Select product/service type to apply
                  </p>
                </div>
